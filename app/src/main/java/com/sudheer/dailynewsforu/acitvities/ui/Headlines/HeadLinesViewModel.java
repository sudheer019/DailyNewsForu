...
public class HeadLinesViewModel extends ViewModel {
    ...
    private MutableLiveData<List<HeadlineModel>> listHeadlineMutableLiveData;

    public HeadLinesViewModel() {
        listHeadlineMutableLiveData = new MutableLiveData<List<HeadlineModel>>();
...
*/
    ...
    public LiveData<List<HeadlineModel>> getHeadlinesList() {
            ...
            try {
                mService.enqueue(new Callback<HeadlineModel>() {
                    ...
                    public void onResponse(Call<HeadlineModel> call, Response<HeadlineModel> response) {
                        ...
                        headlineModels.add(response.body());
